...
pio run -e energy-meter-10 -t upload
```
...
thing name, client ID and topic (`energy-meter-3/data`, `energy-meter-4/data`, `energy-meter-5/data`, `energy-meter-10/data`). Double-check the
...
`python tools/iot_selftest.py --thing energy-meter-10 --publish energy-meter-10/selftest`
