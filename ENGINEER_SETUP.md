...
pio run -e energy-meter-6 -t upload
```
...
thing name, client ID and topic (`energy-meter-3/data`, `energy-meter-4/data`, `energy-meter-5/data`, `energy-meter-6/data`). Double-check the
...
`python tools/iot_selftest.py --thing energy-meter-6 --publish energy-meter-6/selftest`
