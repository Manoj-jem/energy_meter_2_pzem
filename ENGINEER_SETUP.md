...
thing name, client ID and topic (`energy-meter-3/data`, `energy-meter-4/data`, `energy-meter-5/data`, `energy-meter-12/data`). Double-check the
...
To check a meter's credentials first:
...
`python tools/iot_selftest.py --thing energy-meter-12 --publish energy-meter-12/selftest`
